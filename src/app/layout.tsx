...
export const metadata: Metadata = {
  title: 'AutoReception — AI receptionist for home services',
  description:
    'Flat-rate AI receptionist for HVAC, plumbers, electricians, and other home-services businesses. Picks up every call, texts you the lead, no per-minute billing.',
};
    ...
    <footer className='mt-8 flex flex-col gap-8 text-neutral-400 lg:mt-32'>
      ...
      <div className='border-t border-zinc-800 py-6 text-center'>
        <span className='text-neutral4 text-xs'>
          Copyright {new Date().getFullYear()} © AutoReception
        </span>
      </div>
    </footer>
  );
